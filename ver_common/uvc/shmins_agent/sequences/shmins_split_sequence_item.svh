...
class shmins_sequence_item extends uvm_sequence_item;
  ...
  //
  // @param bank_id Physical BANK index.
  // @param baddr Byte address within the selected BANK.
  // @return Composite key containing BANK and BADDR.
  //----------------------------------------------------------------------------
  extern function longint unsigned physical_byte_key(int unsigned bank_id, longint unsigned baddr);
...
function longint unsigned shmins_sequence_item::physical_byte_key(int unsigned bank_id,
