...
- [SHM 定向验证开发计划](shm-directed-verification-development-plan.md)：在 109-case 正向
  基线之上，分批实现双 gid、FFD_CYC、thread mask 和 runtime reset 定向验证，并细化
  第一批双 gid 基础设施、组件测试、coverage 和真实 RTL case。
