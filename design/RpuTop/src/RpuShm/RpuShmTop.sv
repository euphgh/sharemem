...
#(
    ...
    parameter BADDR_W     = MADDR_W-$clog2(BANK_N) - 1 //perbank shm addr space
)(
    //clk && rst
    input                             clk              ,
    input                             rst_n            ,
    ...
    input  logic [THD_N-1:0][255:0]   creq_vdat        ,
    ...
    //BANK REQUEST IO
    input  logic         [VTAB_D-1:0][1:0][3:0]     vlm_wbusy       ,
    input  logic         [VTAB_D-1:0][1:0][3:0]     vlm_rbusy       ,
    ...
    output logic         [BANK_N-1:0][1:0]                      vlm_wgid        ,
    ...
    output logic         [BANK_N-1:0]                       vlm_rgid
);
endmodule
